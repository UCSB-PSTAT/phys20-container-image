        ...
        stage('Build Test Deploy') {
            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        container('podman') {
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME python -c "import matplotlib; import numpy; import scipy; import statsmodels; import scienceplots; import pandas; import math"'
